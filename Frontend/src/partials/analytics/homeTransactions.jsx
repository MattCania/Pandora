...
function TransactionOverview({ type }) {
  // Define chart data for both types
  const datasets = {
    expenses: {
      ...
      borderColor: [
        ...
        "rgb(200, 0, 50)", // November - Slightly darker
      ],
      borderWidth: 2,
    },
    purchases: {
  ...
  return (
    <section className={styles.subSection}>
      <SubHeader
        text={type === "expenses" ? "Total Expenses" : "Total Purchases"}
        subText="as of 2024"
      />
